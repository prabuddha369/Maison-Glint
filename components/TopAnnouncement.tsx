...
export default function TopAnnouncement({
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-center gap-1.5 sm:gap-2 text-xs uppercase tracking-[0.14em] sm:tracking-[0.16em] text-[#111111] overflow-hidden">
        ...
        <button
          ...
          aria-label="Reserve serial numbers 001 through 250 in allocation modal"
