    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 bg-black/65 backdrop-blur-xs animate-fadeIn overflow-y-auto">
      ...
      >
        ...
        <button
          ...
          className="absolute top-4 right-4 sm:top-6 sm:right-6 p-2 text-[#747878] hover:text-[#111111] transition-colors cursor-pointer z-10"
        >
        ...
        <div>
          ...
          <div className="font-[family-name:var(--font-cormorant)] text-[16px] sm:text-[20px] italic text-[#747878] font-light mb-4 sm:mb-6">
            {ritual.subtitle}
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-12 gap-4 sm:gap-6 pt-1 sm:pt-2">
            <div className="sm:col-span-7">
              <div className="text-[9px] sm:text-[10px] uppercase tracking-[0.2em] font-semibold text-[#111111] mb-1.5 sm:mb-2">
                Ritual Narrative
              </div>
            ...
            <div className="sm:col-span-5 bg-[#f4f4f2] border border-[#e5e5e3] p-4 sm:p-5">
              <div className="text-[9px] sm:text-[10px] uppercase tracking-[0.2em] font-semibold text-[#111111] mb-2 sm:mb-3">
                Curated Elements
              </div>
              <ul className="space-y-1.5 sm:space-y-2 text-[11px] sm:text-[12px] text-[#444748] font-light">
        ...
        <div className="pt-4 sm:pt-6 mt-4 sm:mt-6 border-t border-[#e5e5e3] flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 sm:gap-4">
          <div className="text-[9px] sm:text-[10px] uppercase tracking-[0.18em] text-[#747878] text-center sm:text-left">
          ...
          <div className="flex items-center space-x-2 sm:space-x-3">
            <button
              onClick={onClose}
              className="flex-1 sm:flex-none px-4 sm:px-5 py-2.5 sm:py-2.5 border border-[#e5e5e3] text-[9px] sm:text-[10px] uppercase tracking-[0.16em] font-medium text-[#111111] hover:border-[#111111] transition-all cursor-pointer text-center"
            >
              Close
            </button>
            <button
              ...
              className="flex-2 sm:flex-none px-5 sm:px-6 py-2.5 sm:py-2.5 bg-[#111111] text-[#f9f9f7] text-[9px] sm:text-[10px] uppercase tracking-[0.18em] font-medium hover:bg-[#2b2b2b] transition-all cursor-pointer text-center"
            >
