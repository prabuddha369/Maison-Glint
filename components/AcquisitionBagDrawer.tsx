        ...
        <div>
          <div className="flex items-center justify-between border-b border-[#e5e5e3] pb-5 mb-6">
            ...
            <button
              ...
              className="p-2 text-[#595D5D] hover:text-[#111111] transition-colors cursor-pointer"
            >
          ...
          {quantity > 0 ? (
            <div className="space-y-6">
              ...
              <div className="bg-[#f4f4f2] border border-[#e5e5e3] p-3 sm:p-4 flex gap-3 sm:gap-4">
                ...
                <div className="flex-1 flex flex-col justify-between min-w-0">
                  <div>
                    ...
                    <div className="text-xs font-medium text-[#111111] mt-0.5 sm:mt-1">
                  ...
                  <div className="flex items-center justify-between pt-2 border-t border-[#e5e5e3]">
                    <div className="flex items-center border border-[#e5e5e3] bg-[#f9f9f7]">
                      <button
                        ...
                        className="w-8 h-8 flex items-center justify-center text-[#111111] hover:bg-[#e5e5e3] transition-colors text-xs"
                    ...
                    <button
                      ...
                      className="text-xs uppercase tracking-[0.16em] text-[#595D5D] hover:text-[#111111] underline underline-offset-2 py-1 px-1 cursor-pointer"
                    >
                      Remove
                    </button>
                  </div>
              ...
              <div className="space-y-2">
                <label className="block text-xs uppercase tracking-[0.2em] font-semibold text-[#111111]">
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  >
                    <div className="font-medium text-[#111111] uppercase tracking-[0.1em] text-xs">
                      Archival Box
                    </div>
                    <div className="text-xs text-[#595D5D] mt-0.5">
            ...
            <div className="py-16 text-center">
              <p className="text-[13px] text-[#595D5D] font-light mb-6">
              ...
              <button
                ...
                className="inline-flex items-center px-6 py-3 bg-[#111111] text-[#f9f9f7] text-xs uppercase tracking-[0.2em] font-medium"
              >
        ...
        {quantity > 0 && (
          <div className="pt-6 border-t border-[#e5e5e3] space-y-4">
            <div className="flex justify-between text-xs">
              <span className="text-xs uppercase tracking-[0.2em] text-[#595D5D]">
                Delivery
              </span>
            ...
            <div className="flex justify-between items-baseline">
              <span className="text-xs uppercase tracking-[0.2em] font-semibold text-[#111111]">
                Estimated Subtotal
              </span>
            ...
            <button
              ...
              className="w-full bg-[#111111] text-[#f9f9f7] py-4 text-xs uppercase tracking-[0.2em] font-medium hover:bg-[#2b2b2b] transition-all cursor-pointer flex items-center justify-center space-x-2 border border-[#111111]"
            >
